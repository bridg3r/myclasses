...
Important to note however, the p-value for the test of temp does not quite show a significant result (p=0.05481), giving insufficient evidence to conclude that β1≠0.
...
We have a p-value of .7085 we will fail to reject the null that a logistic regression is a good fit for our data and say that the requirements for a logistic regression with this data are met. 

### Conclusion

The results of our test show that there really isn't a strong link between the amount of three pointers made and if the game was won or not. This ultimately shows that anyone who beleives that the Warriors are only a three-point shooting team, does not give the Warriors enough credit for how good and well-rounded that they really are. This ultimately tells us that there were many other factors and things that the warriors did to win their games. Future analysis would be helpful when analyzing other statistics that most strongly led to the Warriors winning their games. Some of these could even be scoring from individual players on the team like Steph Curry or even the impact some of the players may have had off the bench. 
